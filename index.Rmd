...
# Health insurers compete for the favor of insured
...
# However, regulation creates undesirable incentives
...
# These incentives can lead to undesirable behavior
...
These financial incentives can lead to undesirable behavior, both on the part of health insurers (risk selection) and on the part of policyholders (self-selection). This undesirable behavior can lead to negative effects on affordability, access and quality of care.

---

name: risk-equalization

# Risk equalization makes bad behavior unprofitable
